...
L.Playback.MoveableMarker = L.Marker.extend({
    initialize: function (startLatLng, options, feature) {
        ...
        if (marker_options.getPopup_content){
            this.marker_popupContent = marker_options.getPopup_content(feature);
        }

        if (marker_options.bindPopup_option){
            this.bindPopup_option = marker_options.bindPopup_option;
        }

        if(options.popups)
        {
            // this.bindPopup(this.getPopupContent() + startLatLng.toString());
            this.bindPopup(this.getMarkerPopupContent(),this.bindPopup_option);
        }
    ...
    getMarkerPopupContent: function() {
        if (this.marker_popupContent !== ''){
            return this.marker_popupContent;
        }
    ...
    move: function (latLng, transitionTime) {
        ...
        if (this._popup) {
            ...
            this._popup.setContent(this.getMarkerPopupContent());
...
L.Playback.Track = L.Class.extend({
        ...
        initialize : function (geoJSON, options) {
            ...
            this._startTime = t;
            // this._startTime = options.start || this._startTime;
            t += tickLen;
            ...
            // this._endTime = options.end || this._endTime;
